...
Again, you will see a shorter read-out as the package loads. Many students make the mistake of installing packages without loading them. In order to use the package's functions, you musst first load it.
