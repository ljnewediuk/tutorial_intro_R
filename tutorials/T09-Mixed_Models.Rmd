...
* *formula + (1 + response variable | group)* specifies a random slope and intercept model. The response variable(s) is the response variable from your formula over which you expect the group slopes to vary.
