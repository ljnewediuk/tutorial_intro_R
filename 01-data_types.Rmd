...
Today we are going to start with some of the most basic units we will deal with in R and work our way up to some of the most complex. The most basic unit we will deal with are *data types*. Note that there are many data types in R, but we will mostly deal with four: **characters**, **numerics**, **integers**, and **logicals**.
...
You have just created a character data type.
...
### Question 1: What are the data types of (a) 500L, (b) 1e-14, (c) "1"? (be specific as possible!)
